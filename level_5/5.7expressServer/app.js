...
/*Create a route for GET requests to / (root path). Remember,
the callback function takes two arguments: a request req and
a response res.*/
app.get('/', function(req, res){
  
  /*In our new route, issue a request to searchURL and pipe the
