/*So far we've created an Express server.
Now we want to start building a real-time
Q&A moderation service and we've decided to use socket.io.*/

var express = require('express');
var app = express();

//Using the http module, create an new http server
//and pass the express app as the listener for that new server.
var server = require('http').createServer(app);

//Using the socket.io module, listen for requests on the http
...
//Remember, the callback function takes one argument, which is the
//client object that has connected.
